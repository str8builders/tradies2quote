...
Run with Python 3: `python3 scripts/mobile-integration/check_api.py`, then `check_documents_deletion.py` and `check_quote_controls.py`. Failed assertions exit nonzero. Redacted JSON evidence and synthetic PDF fixtures are written to the private directory. Initial fixture setup may add six bucket-configuration checks to the document suite.
